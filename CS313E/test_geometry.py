...
# create objects as needed in setup or other places 
    ...
    def test_002_point_equality(self):
        self.assertTrue(geometry.Point(0, 1, 0) == geometry.Point(0, 1, 0))
        self.assertFalse(geometry.Point(0, 1, 1) == geometry.Point(0, 1, 0))
        # ... Implement here and remove pass


    #TODO! Implement this 
    def test_003_sphere_area(self):
        self.assertTrue(geometry.Sphere(0, 0, 0, 1).area() == (4 * math.pi))
        self.assertTrue(geometry.Sphere(0, 0, 0, 2).area() == (4 * math.pi * 4))

    
    #TODO! Implement this 
    def test_004_sphere_volume(self):
        self.assertTrue(geometry.Sphere(0, 0, 0, 1).volume() == ((4 / 3) * math.pi))

    #TODO! Implement this 
    def test_005_sphere_is_inside_point(self):
        self.assertTrue(geometry.Sphere(0, 0, 0, 2).is_inside_point(self.origin))
